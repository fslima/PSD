...
#	(r'^data/plus/\d{1,2}/$', horas_depois),
	...
	(r'^adiciona/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', adiciona),
	(r'^filtra/(?P<objeto>\w+)', filtra),
	(r'^exibe/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', exibe),
	(r'^edita/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', edita),
	(r'^deleta/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', deleta),
	(r'^finaliza/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', finaliza),
	(r'^aprova/(?P<objeto>\w+)/(?P<idObjeto>\d+)/$', aprova),
